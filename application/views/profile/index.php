          ...
          <div class="box ">
            <div class="box-body box-profile">
              <?php if (@$data[0]['user_foto'] == ''): ?>
                <img class="profile-user-img img-responsive" src="<?php echo @$this->server->offline()?>assets/gambar/noimage.gif" alt="User profile picture" style="margin-bottom: 5%;">
              <?php else: ?>
                <img class="profile-user-img img-responsive" src="<?php echo @$this->server->offline()?>assets/gambar/user/<?php echo @$data[0]['user_foto']; ?>" alt="User profile picture" style="margin-bottom: 5%;">
              <?php endif ?>
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="active  tab-pane" id="settings">
                <form method="post" action="<?php echo @$this->server->offline()?>profile/update/<?php echo $this->session->userdata('id'); ?>" class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="username" class="form-control" value="<?php echo @$data[0]['user_nama']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
              ...
              <div class="tab-pane" id="security">
                ...
                <form id="form" method="post" action="<?php echo @$this->server->offline()?>profile/update_password/<?php echo $this->session->userdata('id'); ?>" class="form-horizontal">
